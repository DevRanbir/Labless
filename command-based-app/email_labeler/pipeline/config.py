...
class TransformConfig:
    ...
    llm_service: str = "openai"  # Options: "openai", "ollama", "gemini", "groq"
...
class PipelineConfig:
    ...
    def from_env(cls) -> "PipelineConfig":
        ...
        if openai_model:
            ...
            service = config.transform.llm_service.lower()
            if service == "ollama":
                ...
                if gemini_model:
                    config.transform.model = gemini_model
            elif service == "groq":
                groq_model = os.getenv("GROQ_MODEL")
                if groq_model:
                    config.transform.model = groq_model
