...
def create_llm_client(service: str = LLM_SERVICE) -> Any:
    """Create an LLM client based on configuration.

    Args:
        service: LLM service type ("OpenAI", "Ollama", "Gemini", or "Groq").
    ...
    if normalized == "ollama":
        ...
        logging.info(f"Creating Gemini client at {GEMINI_BASE_URL}")
