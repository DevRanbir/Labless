...
# LLM Configuration
LLM_SERVICE = os.getenv("LLM_SERVICE", "OpenAI")  # "OpenAI", "Ollama", "Gemini", or "Groq"
...
GROQ_MIN_REQUEST_INTERVAL_SECONDS = os.getenv("GROQ_MIN_REQUEST_INTERVAL_SECONDS", "0.7")
GROQ_MAX_COMPLETION_TOKENS = os.getenv("GROQ_MAX_COMPLETION_TOKENS", "220")
